...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Roblox ID Shop — ຮ້ານຂາຍໄອດີເກມ Roblox" },
      { name: "description", content: "ຮ້ານຂາຍໄອດີເກມ Roblox ຄົບຈົບໃນທີ່ດຽວ ເຕີມເງີນສະດວກ ຮັບໄອດີທັນທີ" },
      { property: "og:title", content: "Roblox ID Shop" },
      { property: "og:description", content: "ຮ້ານຂາຍໄອດີເກມ Roblox ຄົບຈົບໃນທີ່ດຽວ" },
